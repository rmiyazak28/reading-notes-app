    ...
    <div className="glass rounded-lg p-6">
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl font-bold text-foreground break-words">{book.title}</h1>
          {book.author && (
        ...
        <Button
          ...
          onClick={onEdit}
          aria-label="書籍を編集"
          className="shrink-0 text-muted-foreground hover:text-foreground hover:bg-white/10 gap-1.5"
        >
      ...
      <div className="hidden md:grid grid-cols-2 gap-x-8 gap-y-2 mt-4 text-sm text-foreground-secondary">
      ...
      {/* スマホ: 縦並び */}
      <div className="md:hidden flex flex-col gap-2 mt-4 text-sm text-foreground-secondary">
